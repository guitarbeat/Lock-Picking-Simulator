...
const prefix = code.split('{gameState === GameState.SUCCESS && (')[0];
const suffix = '{gameState === GameState.FAIL && (' + code.split('{gameState === GameState.FAIL && (')[1];
