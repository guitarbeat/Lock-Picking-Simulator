...
export const GuideOverlay: React.FC<GuideOverlayProps> = ({ onClose }) => {
    return (
        <div className="fixed inset-0 flex items-center justify-center z-[200] p-2 md:p-4 pointer-events-auto h-[100dvh] w-[100vw]">
            {/* Backdrop */}
            <div 
            ...
            {/* Modal */}
            <div className="hardware-panel border border-[#333] rounded-xl shadow-2xl w-full max-w-4xl h-[95vh] md:max-h-[85vh] overflow-hidden flex flex-col relative text-left">
                {/* Header */}
                <div className="px-6 py-4 border-b border-[#333] flex justify-between items-center bg-[#0d0d0d]">
                    <h2 className="text-lg font-mono font-bold text-[#e0e0e0] uppercase tracking-[4px] flex items-center gap-3">
                    ...
                    <button 
                        onClick={onClose}
                        className="text-[#808080] hover:text-[#f97316] p-2 transition-colors"
                    >
                ...
                {/* Content */}
                <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-8 font-mono text-[11px] text-[#808080] leading-relaxed tracking-wider">
                    
                    <section className="space-y-3">
                        <h3 className="text-xs font-mono font-bold text-[#e0e0e0] uppercase tracking-[2px] border-b border-[#333] pb-2 flex items-center gap-2">
                        ...
                        <ul className="list-disc pl-5 space-y-2 marker:text-[#f97316]">
                            <li><strong className="text-[#e0e0e0]">Key Pins (Bottom Pins):</strong> Rest against the key. They come in varying lengths. In this simulator, they are the lower brass pins.</li>
                            <li><strong className="text-[#e0e0e0]">Driver Pins (Top Pins):</strong> Pressed down by springs. Usually uniform in length. In this simulator, they are the upper steel pins.</li>
                            <li><strong className="text-[#e0e0e0]">The Shear Line:</strong> The gap between the plug and the shell. The lock turns only when all pin pairs separate exactly at this line.</li>
                        </ul>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="p-4 bg-red-900/20 border border-red-500/20 rounded-lg text-red-400 leading-relaxed">
                            <p>
                ...
                {/* Footer */}
                <div className="px-6 py-4 border-t border-[#333] bg-[#0d0d0d] flex justify-end">
                    <button 
                        onClick={onClose}
                        className="hardware-btn px-8 py-3 text-[10px] uppercase font-bold tracking-widest"
                    >
                        Acknowledge
                    </button>
                </div>
