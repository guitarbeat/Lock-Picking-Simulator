...
export const GuideOverlay: React.FC<GuideOverlayProps> = ({ onClose }) => {
    return (
        <div className="absolute inset-0 flex items-center justify-center z-[200] p-4 pointer-events-auto">
            ...
            {/* Modal */}
            <div className="bg-stone-900 border border-stone-700/50 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col relative text-left">
                {/* Header */}
